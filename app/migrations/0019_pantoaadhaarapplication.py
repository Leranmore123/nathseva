# Generated by Django 5.2.5 on 2026-08-14 09:22
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0018_lmscertificateapplication'),
    ]

    operations = [
        migrations.CreateModel(
            name='PanToAadhaarApplication',
            fields=[
                ...
                ('retailer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='pan_to_aadhaar_applications', to='app.retailer')),
            ],
            options={
                'ordering': ['-created_at'],
            },
