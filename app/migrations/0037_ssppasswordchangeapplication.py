# Generated by Django 5.2.5 on 2026-08-17 07:50
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0036_yuvanidhiapplication'),
    ]

    operations = [
        migrations.CreateModel(
            name='SSPPasswordChangeApplication',
            fields=[
                ...
                ('output_pdf', models.FileField(blank=True, null=True, upload_to=app.models.upload_ssp_password_output_pdf)),
                ...
                ('retailer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='ssp_password_applications', to='app.retailer')),
            ],
            options={
                'ordering': ['-created_at'],
            },
