# Generated by Django 5.2.5 on 2026-08-17 06:58
...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('app', '0024_gruhalaxmisanctionapplication'),
    ]

    operations = [
        migrations.CreateModel(
            name='GruhaJyothiApplication',
            fields=[
                ...
                ('output_pdf', models.FileField(blank=True, null=True, upload_to=app.models.upload_gruha_jyothi_output_pdf)),
                ...
                ('retailer', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='gruha_jyothi_applications', to='app.retailer')),
            ],
            options={
                'ordering': ['-created_at'],
            },
