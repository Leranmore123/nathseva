...
urlpatterns = [
    ...
    path('vehicle/rc-advance/', views.vehicle_rc_page, name='vehicle_rc_page'),
    path('vehicle/rc-advance/fetch/', views.vehicle_rc_api, name='vehicle_rc_api'),
    path('vehicle/rc-advance/list/', views.vehicle_rc_list, name='vehicle_rc_list'),
    ...
    path('vehicle/rc-allindia/', views.vehicle_rc_page, name='vehicle_rc_allindia'),
    path('vehicle/rc/pdf/<str:order_id>/', views.vehicle_rc_allindia_pdf, name='vehicle_rc_allindia_pdf'),
    path('vehicle/rc-allindia/pdf/<str:order_id>/', views.vehicle_rc_allindia_pdf, name='vehicle_rc_allindia_pdf_alt'),
